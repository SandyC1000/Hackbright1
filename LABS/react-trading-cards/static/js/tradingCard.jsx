...
ReactDOM.render(<TradingCardContainer />, document.querySelector('#card'));
...
// ReactDOM.render(
//   <TradingCard name="Seedpy" skill="quenching thirst" imgUrl="/static/img/seedpy.jpeg" />,
//   document.querySelector('#seedpy')
// );

// ReactDOM.render(
//   <TradingCard name="OffByOne" skill="pushing thru" imgUrl="/static/img/off-by-one.jpeg" />,
